    ...
    :  QFrame(parent, Qt::FramelessWindowHint )
{
	...
	QHBoxLayout * l = new QHBoxLayout( this );
        ...
        button1->setIcon( QIcon( QPixmap( "popup/xpm/wave.xpm" ) ) );
	button2->setIcon( QIcon( QPixmap( "popup/xpm/setting.xpm" ) ) );
	button3->setIcon( QIcon( QPixmap( "popup/xpm/analysis.xpm" ) ) );
